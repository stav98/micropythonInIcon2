...
Στο αρχείο '<b>Micropython στο σύστημα ρομποτικής.pdf</b>' θα βρείτε οδηγίες για την εγκατάσταση της Micropython στην πλακέτα, οδηγίες για τον κύκλο προγραμματισμού μέσα από το vscode και απλά παραδείγματα προγραμματισμού όλου του υλικού της πλακέτας.

Στο αρχείο '<b>Ασκήσεις Micropython στο σύστημα ρομποτικής.pdf</b>' υπάρχουν πιο σύνθετες ασκήσεις τις οποίες μπορούν να δοκιμάσουν οι μαθητές ώστε να εξοικιωθούν με τον προγραμματισμό υλικού. Το υλικό του αρχείου θα εμπλουτίζεται με νέα πειράματα. 
